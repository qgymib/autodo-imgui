...
typedef struct auto_api_lua_s
{
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_callk
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_compare
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_getfield
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_getglobal
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_geti
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_gettable
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_gettop
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_next
     * @param[in] L     Lua VM.
     * @param[in] idx   The table index.
     * @return          Boolean.
     */
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pop
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pushboolean
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pushcclosure
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pushcfunction
     * @param[in] L     Lua VM.
     ...
     *   this string.
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pushfstring
     * @param[in] L     Lua VM.
    ...
    /**
     * @see Pushes an integer with value \p n onto the stack.
     * @param[in] L     Lua VM.
    ...
    /**
     * @see Pushes a light userdata onto the stack.
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pushlightuserdata
     * @param[in] L     Lua VM.
     ...
     *   stack.
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pushlstring
     * @param[in] L     Lua VM.
     * @param[in] s     String.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pushnil
     * @param[in] L     Lua VM.
     */
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pushnumber
     * @param[in] L     Lua VM.
     ...
     *   stack.
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pushstring
     * @param[in] L     Lua VM.
     * @param[in] s     String.
     * @return          A pointer to the internal copy of the string.
     */
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_pushvalue
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_remove
     * @param[in] L     Lua VM.
     * @param[in] idx   Value index.
     */
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_replace
     * @param[in] L     Lua VM.
     * @param[in] idx   Value index.
     */
     ...
     *   top of the stack.
     * @see http://www.lua.org/manual/5.4/manual.html#lua_rotate
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_setfield
     * @param[in] L     Lua VM.
     ...
     *   global \p name.
     * @see http://www.lua.org/manual/5.4/manual.html#lua_setglobal
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_seti
     * @param[in] L     Lua VM.
     * @param[in] idx   Table index.
    ...
    /**
     * @brief Does the equivalent to t[k] = v.
     * @see http://www.lua.org/manual/5.4/manual.html#lua_settable
     * @param[in] L     Lua VM.
     * @param[in] idx   Table index.
     */
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_toboolean
     * @param[in] L     Lua VM.
     * @param[in] idx   Value index.
     * @return          Boolean.
     */
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_tocfunction
     * @param[in] L     Lua VM.
     * @param[in] idx   Value index.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_tointeger
     * @param[in] L     Lua VM.
     * @param[in] idx   Value index.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_tolstring
     * @param[in] L     Lua VM.
     * @param[in] idx   Value index.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_tonumber
     * @param[in] L     Lua VM.
     * @param[in] idx   Value index.
     * @return          Float number.
     */
    ...
    /**
     * @brief Converts the Lua value at the given index to a C string.
     * @see http://www.lua.org/manual/5.4/manual.html#lua_tostring
     * @param[in] L     Lua VM.
     * @param[in] idx   Value index.
     * @return          C string.
     */
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_touserdata
     * @param[in] L     Lua VM.
     * @param[in] idx   Value index.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_type
     * @param[in] L     Lua VM.
     * @param[in] idx   Value index.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#lua_yieldk
     * @param[in] L     Lua VM.
     * @param[in] nrets The number of results.
     * @param[in] ctx   Context passed to \p k.
     * @param[in] k     Continuation function.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#luaL_ref
     * @param[in] L     Lua VM.
     ...
     * @see http://www.lua.org/manual/5.4/manual.html#luaL_unref
     * @param[in] L     Lua VM.
